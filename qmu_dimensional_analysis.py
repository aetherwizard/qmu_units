...
def search_unit_symbol(symbol):
    if symbol in all_units:
        print(f"\n{get_unit_info(symbol)}")
    else:
        print(f"No unit found with symbol '{symbol}'.")
...
def main():
    ...
    while True:
        ...
        print("2. Search for a unit by name and display information")
        print("3. Search for a unit by symbol and display information")
        print("4. Display units by category")
        print("5. Exit")
        ...
        if choice == '1':
            ...
            query = input("Enter unit name to search: ")
            search_and_display_unit_info(query)
        
        elif choice == '3':
            symbol = input("Enter unit symbol to search: ")
            search_unit_symbol(symbol)
