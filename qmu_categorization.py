# QMU Unit Categorization System
...
def categorize_units():
    for unit_code, unit in all_units.items():
        if unit_code in ['mass', 'leng', 'freq', 'chrg']:
        ...
        elif unit_code in ['trmo', 'vefd', 'efld', 'spch', 'defi', 'chgt', 'chgs', 'chds', 'deff', 'chga', 'chgv', 'chgr', 'defo', 'crsn', 'mcur', 'mcaf', 'qefs', 'qefr', 'qefc', 'chgd', 'qefi', 'efrs', 'mcdf', 'efxd', 'qefp', 'qefe', 'efcd', 'elcg', 'efpm', 'efsu', 'efpt', 'chrg']:
...
def search_unit(query):
    ...
    for unit in all_units.values():
        print(f"Debug: Checking unit {unit.symbol}: {unit.name}")
...
if __name__ == "__main__":
    print("QMU Units Categorization System")
    print("===============================")
    
    display_categorized_units()
    
    print("\nSearch for a unit:")
    search_query = input("Enter unit name or symbol: ")
    search_results = search_unit(search_query)
